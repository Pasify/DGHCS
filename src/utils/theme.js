        ...
        outlined: {
          ...
          colors: {
            ...
            label: {
              ...
              // accent: {
              //   color: "text-blue-gray-400 peer-focus:text-accent",
              //   before:
              //     "before:border-blue-gray-200  peer-focus:before:!border-accent",
              //   after:
              //     "before:border-blue-gray-200  peer-focus:before:!border-accent",
              // },
              accent: {
                color: "text-blue-grey-400 peer-focus:text-secondary",
                before:
                  "before:border-blue-gray-200   peer-focus:before:!border-secondary",
                after:
                  "after:border-blue-gray-200   peer-focus:after:!border-secondary",
              },
            },
          },
          error: {
